...
-- Registering Ice Tornado Effect several times to spawn it in console.Lua one after another
-- number of the effect we need is 43

AttachedEffectManager.register(12, 'Ice Tornado Effect 1', 43, ThingCategoryEffect, {
    speed = 0.5,
    duration = 5000,
    offset = { 30, -30 },
    onAttach = function(effect, owner)
...
AttachedEffectManager.register(13, 'Ice Tornado Effect 2', 43, ThingCategoryEffect, {
    speed = 0.5,
    duration = 5000,
    offset = { 15, -20 },
    onAttach = function(effect, owner)
...
AttachedEffectManager.register(14, 'Ice Tornado Effect 3', 43, ThingCategoryEffect, {
    speed = 0.5,
    duration = 5000,
    offset = { 0, 15 },
    onAttach = function(effect, owner)
...
AttachedEffectManager.register(15, 'Ice Tornado Effect 4', 43, ThingCategoryEffect, {
    speed = 0.5,
    duration = 5000,
    offset = { 0, 40 },
    onAttach = function(effect, owner)
...
AttachedEffectManager.register(16, 'Ice Tornado Effect 5', 43, ThingCategoryEffect, {
    speed = 0.5,
    duration = 5000,
    offset = { 30, 30 },
    onAttach = function(effect, owner)
...
AttachedEffectManager.register(17, 'Ice Tornado Effect 6', 43, ThingCategoryEffect, {
    speed = 0.5,
    duration = 5000,
    offset = { -40, 15 },
    onAttach = function(effect, owner)
...
AttachedEffectManager.register(18, 'Ice Tornado Effect 7', 43, ThingCategoryEffect, {
    speed = 0.5,
    duration = 5000,
    offset = { -40, -40 },
    onAttach = function(effect, owner)
...
AttachedEffectManager.register(19, 'Ice Tornado Effect 8', 43, ThingCategoryEffect, {
    speed = 0.5,
    duration = 5000,
    offset = { 60, 0 },
    onAttach = function(effect, owner)

...
function displayMessage(mode, text)
    ...
    g_logger.info('display message executes...')
    ...
    --     if player then
    --         player:attachEffect(g_attachedEffects.getById(12))
    --         g_logger.info('Effect: ', g_attachedEffects.getById(12))
    --     else
    --         g_logger.error('Player not found: ' .. effectId)
    --     end
    -- end
end
